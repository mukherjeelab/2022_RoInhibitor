...
MFlolli <- ggplot(MF, aes(x=Description, y=-log10(p.adjust))) +
...
ggplot(kegg_res, aes(x=Description, y=p.adjust)) +
  geom_segment( aes(x=Description, xend=Description, y=0, yend=p.adjust), color="black") +
  geom_point( color="red", size=4) +
  theme_light() + coord_flip() +
  theme(
    panel.grid.major.x = element_blank(),
